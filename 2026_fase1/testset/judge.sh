...
problem_dirs=([A]="a_basketball" [B]="b_chatmunarinho" [C]="c_ciclo" [D]="d_descoberta" [E]="e_eco" [F]="f_fotos" [G]="g_ressonancia" [H]="h_segredos" [I]="i_brinquedo" [J]="j_parque" [K]="k_concinnitas")
